  ...
  _createClass(TwitterPoller, [{
    ...
    value: function poll() {
      ...
      return this.assertCanPoll().then(function () {
        _this._context.subscription.set('lastPolled', _moment2['default'].utc().format());
      }).then(function () {
    ...
    value: function assertCanPoll() {
      ...
      return Promise.resolve().then(function () {
        ...
        if (!_this2._context.authorization) {
          ...
          _this2._context.subscription.delayTill(moment(lastPolled).add(frequency, 'seconds').toDate());
